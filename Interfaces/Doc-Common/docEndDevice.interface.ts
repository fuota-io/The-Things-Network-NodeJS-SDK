 ...
 * @property {mqttClient} client - The mqtt client of the downlink event.
 * @property {string} topic - The topic of the downlink event.
 */
 ...
 * @property {mqttClient} client - The mqtt client of the uplink event.
 * @property {string} topic - The topic of the uplink event.
 */
